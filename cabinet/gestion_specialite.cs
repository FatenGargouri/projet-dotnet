...
namespace cabinet
{
    public partial class gestion_specialite : Form
    {
        ...
        private void specialitesBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this.gestion_cabinetDataSet);

        }

        private void gestion_specialite_Load(object sender, EventArgs e)
        {
            // TODO: cette ligne de code charge les données dans la table 'gestion_cabinetDataSet.specialites'. Vous pouvez la déplacer ou la supprimer selon les besoins.
            this.specialitesTableAdapter.Fill(this.gestion_cabinetDataSet.specialites);
